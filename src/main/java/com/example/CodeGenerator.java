...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/springboot_student?characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSL=false");
